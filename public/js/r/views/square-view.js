...
var SquareView = Backbone.View.extend({
    ...
    initialize: function() {
        ...
        //this.thing = p.rect();
        this.el = this.element[0].node;
        console.log(this.element[0].node);
    ...
    render: function() {
       ...
       /* this.thing.attr({
        ...
        group.push(set.push(this.element[0], this.element[1], this.element[2], this.element[3]));
        set.id = i;
		i = i + 1;
        ...
        this.element[1].node.dblclick(function() {
